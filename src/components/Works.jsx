...
const Works = () => {
  ...
  useEffect(() => {
    // Function to update the displayed projects based on screen size
    ...
    window.addEventListener("resize", updateDisplayedProjects);

    // Cleanup the event listener on component unmount
    return () => {
      window.removeEventListener("resize", updateDisplayedProjects);
    };
  }, []);
